...
- [Container](../server/container.html) — the wrapper that subscribes to state and feeds an organism via props, keeping the organism store-agnostic.
