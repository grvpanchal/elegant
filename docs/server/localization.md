...
- [i18next Documentation](https://www.i18next.com/) - Core library, namespaces, plural and interpolation syntax
- [React i18next](https://react.i18next.com/) - `useTranslation` hook, `<Trans>` component, Suspense integration
- [Next.js Internationalization](https://nextjs.org/docs/advanced-features/i18n-routing) - Locale routing, sub-paths, and Accept-Language detection
- [Unicode CLDR Plural Rules](https://cldr.unicode.org/index/cldr-spec/plural-rules) - Authoritative plural categories per language
- [MDN Intl API](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl) - `DateTimeFormat`, `NumberFormat`, `RelativeTimeFormat`, `PluralRules`
- [CSS Logical Properties](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties) - `inline-start`/`block-end` properties for bidi-safe layouts
- [Google Search Central: Managing Multi-Regional Sites](https://developers.google.com/search/docs/specialty/international/managing-multi-regional-sites) - hreflang, URL structure, geotargeting guidance
