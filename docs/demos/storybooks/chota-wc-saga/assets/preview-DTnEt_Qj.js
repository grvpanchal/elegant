const a={parameters:{controls:{matchers:{color:/(background|color)$/i,date:/Date$/i}}}},t=`/*!
...
`,r=new CSSStyleSheet;r.replaceSync(t);const e=new CSSStyleSheet;e.replaceSync(o);document.adoptedStyleSheets=[...document.adoptedStyleSheets,r,e];export{a as default};
